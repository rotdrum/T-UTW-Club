...
<body>
    <section id="admin-app" class="admin-container">
        ...
        <div class="admin-dashboard">
            ...
            <h4>ตั้งค่าระบบ</h4>
            <h1>ข้อมูลนักเรียนรายห้อง (ม.<?php echo $_POST['class'] ;?>/<?php echo $_POST['room'] ;?>)</h1>
            ...
            <table  id="myTable">
                ...
                <tbody>
                    ...
                    <?php 
                $stmt = $pdo->query("select * from student where class = ".$_POST['class']." and room = ".$_POST['room']."  order by ordinal");
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                ?>
                    <tr >
                        <td>
                            <p><?php echo $row['ordinal'] ; ?></p>
                        </td>
                        <td>
